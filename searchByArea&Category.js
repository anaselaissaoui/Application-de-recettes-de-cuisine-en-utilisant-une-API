    ...
    if(selectedCategory==="" && selectedArea!==""){
        ...
        .then((areaf)=>{
            ...
            areaf.meals.forEach((meal) =>{
                            ...
                            var html;
                            html = "<div class = 'card text-center col-lg-3 col-md-5 cold-sm-10 m-1 ' id='cardsHere'     style='background-color: rgb(255,33,79, 0.4)'>" +
                            "<img src=" +
                            meal.strMealThumb +
...
//   const mergedMeals = areaFMeals.filter(idMeal => cateFMeals.includes(idMeal));

 
// const mergedMeals = resultArea.filter(meals.meal.idMeal => resultCate.includes(meals.meal.idMeal));
    ...
    // const intersection = [...new Set(data.filter(meals.meal => data1.includes(meals.meal)))];
}}} 
